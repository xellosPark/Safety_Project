...
CSafetyDlg::CSafetyDlg(CWnd* pParent /*=NULL*/)
...
void CSafetyDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CSafetyDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CSafetyDlg::OnBnClickedButton1()
{
	CDlgSafetyView Dlg;
	Dlg.DoModal();
}
